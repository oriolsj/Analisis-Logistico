...
Probamos con el organismo para el cual hay más pacientes. 

```{r}
data_epi = data[ data$Descripción == "Staphylococcus epidermidis",]

tree_model <- rpart(Penicilina...Sensibilidad ~ Edad.del.Paciente+Sexo.del.Paciente+Peso, data = data_epi, na.action = na.omit)
